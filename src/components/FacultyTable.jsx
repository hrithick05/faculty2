...
const FacultyTable = ({ 
  ...
  // Filter faculty based on search - only Computer Science department
  const filteredFaculty = facultyData.filter(faculty => {
    ...
    if (!isComputerScience) return false;
    ...
    <>
      ...
      <CardHeader className="space-y-4">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
          <CardTitle className="text-xl font-bold dark:text-white">Faculty Achievement Overview (60%)</CardTitle>
